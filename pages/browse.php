        ...
        <div class="br-filters">
          <form id="filter-form" onsubmit="return false">
            ...
            <div class="mb-4">
              ...
              <div class="br-filter-opt">
                <input type="radio" name="category_id" value="<?= $cat['id'] ?>" id="cat-<?= $cat['id'] ?>" class="form-check-input" onchange="applyFilters()">
                <label for="cat-<?= $cat['id'] ?>" class="mb-0 w-100" style="cursor:pointer"><?= htmlspecialchars($cat['name']) ?></label>
              </div>
              <?php endforeach; ?>
            </div>
            ...
            <div class="mb-4">
              ...
              <div class="d-flex gap-2">
                <input type="number" name="min_price" class="br-form-control" placeholder="Min" min="0" onchange="applyFilters()">
                <input type="number" name="max_price" class="br-form-control" placeholder="Max" min="0" onchange="applyFilters()">
              </div>
            </div>
            ...
            <div class="mb-4">
              ...
              <div class="br-filter-opt">
                <input type="radio" name="min_rating" value="<?= $r ?>" id="r-<?= str_replace('.','_',$r) ?>" <?= $r === '' ? 'checked' : '' ?> class="form-check-input" onchange="applyFilters()">
            ...
            <div class="mb-4">
              ...
              <div class="br-filter-opt">
                <input type="checkbox" name="verified_only" value="1" id="verified" class="form-check-input" onchange="applyFilters()">
                <label for="verified" class="mb-0" style="cursor:pointer">✅ Verified Only</label>
              </div>
              <div class="br-filter-opt">
                <input type="checkbox" name="available_only" value="1" id="available" class="form-check-input" onchange="applyFilters()">
    ...
    <div class="col-12 col-sm-6 col-xl-4">
      <a href="${APP_URL}/pages/expert-profile.php?id=${e.user_id}" class="text-decoration-none">
        <div class="br-card br-expert-card p-4 h-100">
          ${e.is_verified ? '<div class="position-absolute top-0 end-0 m-3"><span class="br-badge br-badge-teal">✓ Verified</span></div>' : ''}
          ...
          <div class="d-flex justify-content-between align-items-center pt-3" style="border-top:1px solid var(--br-border)">
            ...
            <div class="text-end">
              ...
              <div style="font-size:.7rem;${e.is_available=='1' ? 'color:#4ecb71' : 'color:var(--br-text3)'}">
                ${e.is_available=='1' ? '🟢 Available' : '⚪ Busy'}
              </div>
            </div>
          </div>
        </div>
